...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.queryData("Insert into ToDoList values(null, 'Project Android')");
        db.queryData("Insert into ToDoList values(null, 'Design app')");
        db.queryData("Insert into ToDoList values(null, 'Graphic Design')");
        db.queryData("Insert into ToDoList values(null, 'International Business')");
        db.queryData("Insert into ToDoList values(null, 'Help lake')");
        db.queryData("Insert into ToDoList values(null, 'Software Engineering')");
